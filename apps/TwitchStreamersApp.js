...
const TwitchStreamersApp = async () => {
    console.log(chalk.hex('#a970ff')(`[Twitch Streamers]: ${new Date(Date.now()).toLocaleString()}`))
    console.log(chalk.hex('#a970ff')('[Twitch Streamers]: Запуск проверки состояния стримов...'))
    try {
